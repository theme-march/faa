          ...
          <>
            <InputField
              ...
              options={[
                {
                  value: "S",
                  label: 'T- Shirt: S - Body Length 68" chest 49".',
                },
                {
                  value: "M",
                  label: 'T- Shirt: M - Body Length 70" chest 51".',
                },
                {
                  value: "L",
                  label: 'T- Shirt: L - Body Length 72" chest: 53".',
                },
                {
                  value: "XL",
                  label: 'T- Shirt: XL - Body Length 74" chest 56"',
                },
                {
                  value: "XXL",
                  label: 'T- Shirt: XXL - Body Length 76" chest 59"',
                },
              ]}
